...
class KVideoControls extends StatefulWidget {
  final VideoPlayerController controller;
  final Key playerKey;
  final bool isFullScreen;

  const KVideoControls(
    this.controller, {
    Key key,
    this.playerKey,
    this.isFullScreen,
  ...
  @override
  _KVideoControlsState createState() => _KVideoControlsState();
}

class _KVideoControlsState extends State<KVideoControls> {
  ...
  void _positionListener() {
    _positionSubject.add(_formatDuration(widget
                            .controller?.value?.position?.inMilliseconds) ??
                        '0.0');
    _durationSubject.add( _formatDuration(widget
    ...
    @override
  void didUpdateWidget(KVideoControls oldWidget) {
